...
> Phase guides are published incrementally. Phases 0, 1, 2, 3 and 4 are live; links to later phases
> activate as each one is written. The schedule, gates, and pacing below are final and usable today.
